...
public class Exam0330 {
  ...
  public static void main(final String[] args) {
    ...
    // => 즉 다음과 같이 sm()을 호출할 때 Exam0330 객체 없이 호출한다면,
    // sm() 메소드 안에서는 절대로 Exam0330 객체를 사용할 수 없는 것이다.
    // => 그래서 스태틱 메소드 안에 있는 로컬 클래스에서는
  ...
  static void sm() {
    class A {
      ...
      // 스태틱 메소드에서는 바깥 클래스의 인스턴스 주소를 알 수 없기 때문에
      // 스태틱 메소드 안에 로컬 클래스를 정의하는 경우
      ...
      void m1() {
        ...
        // Exam 0330.this.iValue = 100; // 컴파일 오류!
      }
    }
