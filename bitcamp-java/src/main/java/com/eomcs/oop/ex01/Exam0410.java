...
//   > javac -encoding UTF-8 -d bin src/step03/Exam0410.java 
// - 이유?
...
// - 해결책?
//   컴파일러에 Score 클래스에 대한 정보를 알려줘라! -classpath class파일이 있는 곳을 알려줌
// 방법1) Score.class 파일을 갖고 있다면 그 파일이 있는 위치를 알려줘라.
//   > javac -encoding UTF-8 -d bin -classpath bin/main src/step03/Exam0410.java
// 
