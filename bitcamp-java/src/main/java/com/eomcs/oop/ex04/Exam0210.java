...
public class Exam0210 {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(s1.compareTo("Helli") > 0);
        System.out.println(s1.compareTo("Hello") == 0);
        System.out.println(s1.compareTo("Hellu") < 0);
        
        System.out.println(s1.contains("ll")); // ll이 포함되어 있나?
        System.out.println(s1.contains("ee")); // ee가 포함되어 있나?
