...
class Score3 {
  ...
  // 방법?
  // => 직접 필드의 값을 바꾸게 하지 말고 메소드를 통해 바꾸도록 유도한다.
  ...
  // 대신 메소드를 통해 값을 설정하게 하라!
  // 보통 필드의 값을 설정하는 메소드는 set필드명()으로 이름을 짓는다.
  // => 이런 메소드를 "세터(setter)"라 부른다.
...
public class Exam0310 {
  public static void main(String[] args) {
    ...
    // 다음과 같이 언제든지 국, 영, 수 점수를 변경하더라고
    // 합계와 평균이 자동계산될 것이다.
    s1.setEng(100);
    s1.setMath(100);
    
    // 이제 kor, eng, math도 비공개 모드이기 때문에
    // 값을 조회하려면 getter를 사용해야 한다.
