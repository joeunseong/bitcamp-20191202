...
// 3) worker 를 사용하는 측에서는 Worker 인터페이스에 정의된 대로 메소드를 호출한다.
// => Exam01 클래스 변경
public class Exam01 {
  public static void main(String[] args) {
    ...
    // 다음과 같이 동일한 사용규칙에 따라 메소드를 호출할 수 있어 편리하다.
    ...
    // => Worker 사용 규칙에 따라 작성된 클래스의 인스턴스 주소를 저장하는 변수 w.
    // => Worker 인터페이스를 구현한 클래스와 인스턴스 주소를 저장하는 변수 w.
