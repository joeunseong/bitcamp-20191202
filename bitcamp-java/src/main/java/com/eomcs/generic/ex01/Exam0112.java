...
public class Exam0112 {
  ...
  public static void main(String[] args) {
    ...
    //
    // 이런 문제점을 해결하기 위해 나은 문법이 "제네릭(Generic)" 이다.
