...
public class Exam61 {
  public static void main(String[] args) {
    ...
    // => 가비지는 JVM 실행 중에 메모리가 부족할 때 "가비지 수집기(garbage collector)"에 의해 메모리에서 해제된다.
    // => 물론, JVM을 종료하면 당연히 JVM이 사용하던 모든 메모리는 OS에 반납되기 때문에 가비지 또한 반납될 것이다.
    ...
    //레퍼런스를 생성한 다음에 값을 초기화시킬때는 
    //new int[]를 생략할 수 없다.
    int[] arr8;
    //arr9 = {100, 90, 80}; //컴파일 오류!
