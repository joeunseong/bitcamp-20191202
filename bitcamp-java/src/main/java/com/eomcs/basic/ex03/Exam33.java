...
public class Exam33 {  //공개 클래스인 경우 클래스명과 파일명은 꼭 같아야 함
  ...
  public static void main(String[] args) {
    ...
    System.out.println(Double.MIN_VALUE); //8바이트 부동소수점

    //4바이트 부동소수점 최소/최대 값
    System.out.println(Float.MAX_VALUE); //4바이트 부동소수점
    System.out.println(Float.MIN_VALUE); //4바이트 부동소수점
    ...
    //   그래서 부동소수점은 메모리에서 꺼낸 값을 내부의 규칙에 따라 
    //   보정해준다.
