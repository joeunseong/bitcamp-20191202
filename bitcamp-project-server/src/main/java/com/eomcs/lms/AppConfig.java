...
public class AppConfig {
  ...
  public MybatisDaoFactory daoFactory(
      // 이 메소드를 호출할 때 Spring IoC 컨테이너에 들어 있는 객체를 원한다며느
      // 이렇게 파라미터로 선언하라.
      // 그러면 Spring IoC 컨테이너가 이 팩토리 메소드를 호출하기 전에
      // SqlSessionFactory를 먼저 준비한 다음에 이 메소드를 실행할 것이다.
