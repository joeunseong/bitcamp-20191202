...
public class App {
  ...
  public static void main(String[] args) {
    ...
    //
    // 반드시  AbstractList의 일반 하위 객체를 정의해야한다.
    //
  ...
  // printCommandHistory()와 printCommandHistory2() 메소드를 따로 정의했다.
