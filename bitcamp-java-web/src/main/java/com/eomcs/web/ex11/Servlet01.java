...
public class Servlet01 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // => 웹 브라우저는 세션 아이디를 쿠키에 보관해 두었다가 그 서버에 요청할 때 마다
    // 세션 아이디를 보낸다.
    // 왜? 세션 아이디는 쿠키이다.
    ...
    // => 생성한 세션의 아이디는 쿠키를 통해 응답할 때 웹 브라우저로 보낸다.
    // => HTTP 응답 프로토콜
    //
    // HTTP/1.1 200
    // Set-Cookie: JSESSIONID=27322F452E8FF79B68A22B1425359C93; Path=/bitcamp-java-web; HttpOnly
    // Content-Type: text/plain;charset=UTF-8
    // Content-Length: 45
    // Date: Wed, 08 Apr 2020 03:13:47 GMT
