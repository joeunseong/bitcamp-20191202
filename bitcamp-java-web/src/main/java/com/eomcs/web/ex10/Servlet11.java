...
public class Servlet11 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    //
    // HTTP/1.1 200
    // Set-Cookie: v1=aaa => 유효기간을 설정하지 않았기 때문에 웹브라우저는 닫으면 쿠키가 날아감
    // Set-Cookie: v2=bbb; Max-Age=30; Expires=Wed, 08-Apr-2020 02:41:30 GMT
    // Set-Cookie: v3=ccc; Max-Age=60; Expires=Wed, 08-Apr-2020 02:42:00 GMT
    // Content-Type: text/plain;charset=UTF-8
    // Content-Length: 37
    // Date: Wed, 08 Apr 2020 02:41:00 GMT
