...
public class Servlet21 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // HTTP/1.1 200 Set-Cookie: v1=aaa <---- 사용 범위가 지정되지 않았다.
    // Set-Cookie: v2=bbb; Path=/bitcamp-java-web/ex10/a <--- 사용 범위가 /java-web/ex10/a 로 제한되었다.
    ...
    // 서버가 다룰 때는 컨텍스트 루트
    // 웹브라우저로 다룰 때는 서버루트(브라우저가 바라보는 경로)
  }
}
